...
// create the two EditTexts for the candy's name and price
                ...
                button[i].setText("Update");
                button[i].setId(candy.getId());
                ...
                grid.addView(button[i], (int) (width * .35), ViewGroup.LayoutParams.WRAP_CONTENT);
                i++;
            }
